...
export default function DestinationContainer(props: ContainerProps) {
  ...
  return (
    ...
    >
      ...
      <div ref={setNodeRef} 
   className={clsx(
    "flex flex-row m-10 p-1 gap-1 flex-wrap justify-start bg-gray-100 h-12 w-full border-b-2 border-gray-400", // Add bottom border
    id === "destination_container" ? "bg-gray-100" : "bg-cyan-100"
  )}
        >
